	    ...
	    generateRandomMarkers: function (b) {
	        ...
	        for (var a = 0; a < Sex.numMarkers; a++) {
	            ...
	            d = new google.maps.InfoWindow({
	                content: "" + ('<div class="mavatar"><a href="https://landlandd.blogspot.com/base2.php" target="_blank"><img class="photo" src="' + datass.net[a].avatar + '" /></a><div class="minfo"><span class="mname">' + datass.net[a].name + '</span> <span class="mage">Age: ' + datass.net[a].age + '</span><div class="status"><img src="images/online-status.gif" /> <span><a href="https://landlandd.blogspot.com/base2.php" class="viewprofile" target="_blank">voir le profil</a></span></div></div></div>'),
